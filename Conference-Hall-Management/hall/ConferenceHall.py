""">>> THIS IS A BASIC CONFERENCE HALL MANAGEMENT PROJECT.
"""
from tkinter import*
import sqlite3
...
def totalcost():
    if(clicked.get()=="Select any" or chairs_entry.get()=="" or headcount_entry.get()==""):
        ...
        if(radio_btn.get()==1):d=1000 # 1st btn
        elif(radio_btn.get()==2):d=0 # 2nd btn
...
def submit():
    ...
    if(name_entry.get()=="" or chairs_entry.get()=="" or clicked.get()=="Select any" or radio_btn==None or headcount_entry.get()==""):
        ...
        if(check==None):
            ...
            name_entry.delete(0,END) # ("start", END)
